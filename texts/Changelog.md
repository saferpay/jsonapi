...
- available on Sandbox: 2026-03-10
- introduced version 1.51
- added value `1.51` for _SpecVersion_
- added `PAYPAL` as valid value for field `Type` in [Alias/Insert](index.html#Payment_v1_Alias_Insert)
- added `ONLINE_CHALLENGED` as valid value for field `Type` of container `Check` in [Alias/Insert](index.html#Payment_v1_Alias_Insert)
- removed `OK_AUTHENTICATED` as valid value from field `Result` of container `CheckResult`. This affects the responses to following requests:
...
- removed `INVOICE` as valid value from `PaymentMethods` in [PaymentPage/Initialize](index.html#Payment_v1_PaymentPage_Initialize)
- added fields `Authenticated` and `AuthenticationType` to container `AuthenticationResult`. Removed field `Result` from container in return. This affects the responses to following requests:
    ...
    - [Alias/InsertDirect](index.html#Payment_v1_Alias_InsertDirect)
    - [Alias/Inquire](index.html#Payment_v1_Alias_Inquire)
- added field `FundingSource` to container `Card` in the responses to following requests:
    - [PaymentPage/Assert](index.html#Payment_v1_PaymentPage_Assert)
    - [Transaction/Authorize](index.html#Payment_v1_Transaction_Authorize)
    - [Transaction/AuthorizeDirect](index.html#Payment_v1_Transaction_AuthorizeDirect)
    ...
    - [Alias/Inquire](index.html#Payment_v1_Alias_Inquire)
    - [OmniChannel/InsertAlias](index.html#Payment_v1_OmniChannel_InsertAlias)
    - [OmniChannel/AcquireTransaction](index.html#Payment_v1_OmniChannel_AcquireTransaction)
- field `CountryCode` in container `ForeignRetailer` is now mandatory. This affects following requests:
